...
results_00 = [
    get_result(0, evolution_result[0]),
    get_result(1, evolution_result[0]),
    get_result(2, evolution_result[0]),
    get_result(3, evolution_result[0]),
    get_result(4, evolution_result[0]),
    get_result(5, evolution_result[0])
]
results_10 = [
    get_result(0, evolution_result[1]),
    get_result(1, evolution_result[1]),
    get_result(2, evolution_result[1]),
    get_result(3, evolution_result[1]),
    get_result(4, evolution_result[1]),
    get_result(5, evolution_result[1])
]
