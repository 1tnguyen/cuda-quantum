...
// Finish the table and export the service factory used by
// cudaq_internal::device_call::initializeDeviceCallRuntime/finalizeDeviceCallRuntime.
// The CUDA-Q runtime owns function table allocation and dispatch session lifecycle.
#define CUDAQ_DEVICE_CALL_LIBRARY_END()                                        \
